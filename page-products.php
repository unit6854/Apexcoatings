    ...
    <div class="container">
        ...
        <div style="display:flex;flex-wrap:wrap;gap:10px;margin-bottom:40px;" role="group" aria-label="Filter by category">
            <a href="<?php echo get_permalink(); ?>"
               class="btn btn-sm <?php echo !$active_cat ? 'btn-primary' : 'btn-outline-dark'; ?>"
               style="font-size:0.8rem;">All</a>
            <?php foreach ($categories as $cat): ?>
            <a href="<?php echo add_query_arg('cat', $cat->slug, get_permalink()); ?>"
               class="btn btn-sm <?php echo ($active_cat === $cat->slug) ? 'btn-primary' : 'btn-outline-dark'; ?>"
        ...
        <div class="services-grid">
            ...
            <div class="service-card reveal">
                ...
                <?php if ($thumb_id): ?>
                <a href="<?php echo get_permalink($pid); ?>" style="display:block;aspect-ratio:16/10;overflow:hidden;background:var(--apex-black);">
                ...
                <div class="card-body">
                    <div style="display:flex;justify-content:space-between;align-items:flex-start;gap:10px;margin-bottom:8px;">
                        <h2 class="card-name" style="font-size:1.25rem;">
                            <a href="<?php echo get_permalink($pid); ?>" style="color:inherit;text-decoration:none;"><?php echo get_the_title($pid); ?></a>
                        </h2>
                        <?php if ($in_stock === '1'): ?>
                    ...
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-top:auto;">
                        <a href="<?php echo get_permalink($pid); ?>" class="btn btn-outline-dark btn-sm" style="justify-content:center;">Details</a>
        ...
        <div style="text-align:center;padding:80px;">
            <p>No products listed yet. <a href="<?php echo home_url('/contact'); ?>">Contact us</a> for a custom quote.</p>
        </div>
        <?php endif; ?>
    </div>
</section>
