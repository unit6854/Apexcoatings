...
<div class="checkout-page-wrap">
    <div class="container">
        ...
        <div class="cart-page-header">
            <a href="<?php echo home_url('/cart'); ?>" class="page-back-link">
                    ...
                    <div class="form-step" id="step-3">
                        <div class="confirmation-wrap">
                            ...
                            <div style="display:flex;gap:12px;justify-content:center;flex-wrap:wrap;">
                                <a href="<?php echo home_url('/products'); ?>" class="btn btn-primary">Shop More</a>
                                <a href="<?php echo home_url('/'); ?>" class="btn btn-outline-dark">Go Home</a>
                            </div>
                        </div>
                    </div>
