...
<div class="grips-hero">
    <div class="container">
        <span class="eyebrow" style="display:block;margin-bottom:10px;"><?php echo esc_html( apex_opt( 'grips_page_eyebrow', 'Custom 1911 Accessories' ) ); ?></span>
        <h1 class="section-title" style="color:var(--apex-white);margin-bottom:16px;"><?php echo esc_html( apex_opt( 'grips_page_h1', '1911 Grip Panels' ) ); ?></h1>
        <p class="grips-hero-desc"><?php echo esc_html( apex_opt( 'grips_page_desc', "Each grip panel is individually crafted and finished in-house. Whether you're after the durability of Cerakote, the classic look of natural aluminum, or the warmth of real wood — we have a grip to match your 1911 and your style. This product line is expanding regularly." ) ); ?></p>
        <div class="grips-badges">
            <span class="grips-badge"><?php echo esc_html( apex_opt( 'grips_page_badge_1', '✓ Made In-House' ) ); ?></span>
            <span class="grips-badge"><?php echo esc_html( apex_opt( 'grips_page_badge_2', '✓ Multiple Finishes Available' ) ); ?></span>
            <span class="grips-badge"><?php echo esc_html( apex_opt( 'grips_page_badge_3', '✓ Custom Options — Quote Based' ) ); ?></span>
            <span class="grips-badge"><?php echo esc_html( apex_opt( 'grips_page_badge_4', '✓ Prices start at $90' ) ); ?></span>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="grips-info-grid">
            <div class="grips-info-item">
                ...
                <div>
                    <strong><?php echo esc_html( apex_opt( 'grips_info_1_title', 'Built to Last' ) ); ?></strong>
                    <span><?php echo esc_html( apex_opt( 'grips_info_1_desc', 'Quality materials, quality finishes' ) ); ?></span>
                </div>
            </div>
            <div class="grips-info-item">
                ...
                <div>
                    <strong><?php echo esc_html( apex_opt( 'grips_info_2_title', 'Turnaround' ) ); ?></strong>
                    <span><?php echo esc_html( apex_opt( 'grips_info_2_desc', '5–10 business days' ) ); ?></span>
                </div>
            </div>
            <div class="grips-info-item">
                ...
                <div>
                    <strong><?php echo esc_html( apex_opt( 'grips_info_3_title', 'Pricing' ) ); ?></strong>
                    <span><?php echo esc_html( apex_opt( 'grips_info_3_desc', 'Apex exclusives $90' ) ); ?></span>
                </div>
            </div>
            <div class="grips-info-item">
                ...
                <div>
                    <strong><?php echo esc_html( apex_opt( 'grips_info_4_title', 'Custom designed grips' ) ); ?></strong>
                    <span><?php echo esc_html( apex_opt( 'grips_info_4_desc', 'Quote-based · Contact us' ) ); ?></span>
                </div>
            </div>
        </div>
    </div>
...
<section class="grips-section">
    <div class="container">
        <div class="grips-section-header">
            <h2 class="section-title" style="color:var(--apex-white);"><?php echo esc_html( apex_opt( 'grips_grid_heading', 'Apex Exclusive Designs' ) ); ?></h2>
            <p style="color:rgba(255,255,255,0.55);margin-top:8px;"><?php echo esc_html( apex_opt( 'grips_grid_subtext', 'Each set is made to order right here in America — never mass-produced overseas. Time, skill, and craftsmanship go into every piece we make.' ) ); ?></p>
        </div>
        ...
        <div class="grips-custom-cta">
            <div class="grips-custom-inner">
                <div>
                    ...
                    <p style="color:rgba(255,255,255,0.6);margin:0;">Our 1911 grip lineup is growing. If you have a specific finish, material, or engraving in mind — reach out and we'll work with you to bring your vision to life.</p>
                </div>
                <a href="<?php echo esc_url( home_url('/contact') ); ?>" class="btn btn-outline" style="white-space:nowrap;flex-shrink:0;">Request Custom Grip</a>
            </div>
        </div>
    </div>
</section>
...
<div id="grips-lightbox" style="display:none;position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:9999;align-items:center;justify-content:center;flex-direction:column;" onclick="closeGripsLightbox()">
    ...
    <img id="grips-lightbox-img" src="" alt="" data-no-optimize="1" style="max-width:92vw;max-height:85vh;width:auto;height:auto;object-fit:contain;border-radius:6px;box-shadow:0 8px 48px rgba(0,0,0,0.6);display:block;" onclick="event.stopPropagation()">
...
(function(){ var _lb = document.getElementById('grips-lightbox'); if (_lb) document.documentElement.appendChild(_lb); })();
...
function apexGripsAddToCart(id, name) {
    ...
    var imgSrc = '';
    if (btn) {
        var card = btn.closest('.grips-card');
        if (card) {
            var img = card.querySelector('.grips-card-img');
