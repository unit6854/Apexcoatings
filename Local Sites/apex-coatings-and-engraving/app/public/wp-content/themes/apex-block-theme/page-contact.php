...
<div style="background:var(--apex-black);padding:140px 0 60px;">
    <div class="container">
        <span class="eyebrow" style="display:block;margin-bottom:12px;"><?php echo esc_html( apex_opt( 'contact_page_eyebrow', 'Get in Touch' ) ); ?></span>
        <h1 class="section-title" style="color:var(--apex-white);"><?php echo esc_html( apex_opt( 'contact_page_h1', 'Contact Us' ) ); ?></h1>
        <p style="color:rgba(255,255,255,0.55);max-width:480px;line-height:1.7;"><?php echo esc_html( apex_opt( 'contact_page_desc', "Have a custom project in mind? Need a quote? We'll get back to you within 1-2 business days." ) ); ?></p>
    </div>
</div>
...
<section class="contact-page-wrap" style="padding-top:64px;">
    <div class="container">
        <div class="contact-grid">
            ...
            <!-- Left: Info -->
            <div>
                <h2 style="font-family:'Barlow Condensed',sans-serif;font-size:2.2rem;font-weight:900;text-transform:uppercase;margin-bottom:16px;"><?php echo esc_html( apex_opt( 'contact_left_h2', "Let's Build Something Exceptional" ) ); ?></h2>
                <p style="color:var(--apex-gray-dark);line-height:1.8;margin-bottom:36px;"><?php echo esc_html( apex_opt( 'contact_left_desc', "Whether it's a single custom piece or a large production run, we handle every job with the same level of precision and care. Tell us what you need — we'll make it happen." ) ); ?></p>
                ...
                <div class="contact-details">
                    <div class="contact-detail">
                        ...
                        <div class="contact-detail-text">
                            <strong>Email</strong>
                            <span><?php echo antispambot( apex_opt( 'contact_email', 'orders@apexcoatingstn.com' ) ); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="contact-detail">
                        ...
                        <div class="contact-detail-text">
                            ...
                            <span><?php echo nl2br( esc_html( apex_opt( 'contact_hours', "Mon–Fri: 8AM – 5PM\nSat: 9AM – 2PM" ) ) ); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="contact-detail">
                        ...
                        <div class="contact-detail-text">
                            ...
                            <span><?php echo nl2br( esc_html( apex_opt( 'contact_location', "Available for drop-off & pickup\nContact us for address" ) ) ); ?></span>
                        </div>
                    </div>
                </div>
            </div>
...
<section style="background:var(--apex-off-white);padding:60px 0;border-top:1px solid var(--apex-gray-light);margin-top:80px;">
    <div class="container text-center">
        <h2 class="section-title" style="margin-bottom:16px;"><?php echo esc_html( apex_opt( 'contact_cta_h2', 'Ready to Order?' ) ); ?></h2>
        <p style="color:var(--apex-gray-dark);margin-bottom:32px;max-width:480px;margin-left:auto;margin-right:auto;"><?php echo esc_html( apex_opt( 'contact_cta_desc', 'Browse our product catalog, add items to your cart, and submit your order request. Fast and easy.' ) ); ?></p>
        <a href="<?php echo esc_url( home_url('/products') ); ?>" class="btn btn-primary">Browse Products</a>
    </div>
</section>
